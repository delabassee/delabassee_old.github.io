...
#How to setup Cargo Tracker in NetBeans

##Prerequisites

* JDK 7 or higher (JDK 8 recommended)
* GlassFish 4.1
* NetBeans 7.4 or higher (NetBeans 81. recommended)
